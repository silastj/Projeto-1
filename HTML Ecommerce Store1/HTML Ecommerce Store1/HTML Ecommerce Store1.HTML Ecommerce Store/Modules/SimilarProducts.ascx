<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SimilarProducts.ascx.cs" Inherits="HTML_Ecommerce_Store1.HTML_Ecommerce_Store.Modules.SimilarProducts" %>
