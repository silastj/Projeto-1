<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductCardMini1.ascx.cs" Inherits="HTML_Ecommerce_Store1.HTML_Ecommerce_Store.Modules.ProductCardMini" %>
