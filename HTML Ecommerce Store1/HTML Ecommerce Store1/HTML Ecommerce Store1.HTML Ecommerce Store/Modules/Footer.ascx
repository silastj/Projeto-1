<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Footer.ascx.cs" Inherits="HTML_Ecommerce_Store1.HTML_Ecommerce_Store.Modules.Footer" %>
<footer class="footer">
    <div class="row">
        <div class="small-12 medium-6 large-3 columns">
            <p class="about">About Lorem ipsum</p>
        ...
        <div class="small-12 medium-6 large-3 columns">
            ...
            <ul class="footer-links">
                <li>Monday - Friday:<div class="float-right">9am - 6pm</div>
                </li>
                <li>Saturday:<div class="float-right">9am - 5pm</div>
                </li>
                <li>Sunday:<div class="float-right">Closed</div>
                </li>
            </ul>
        </div>
