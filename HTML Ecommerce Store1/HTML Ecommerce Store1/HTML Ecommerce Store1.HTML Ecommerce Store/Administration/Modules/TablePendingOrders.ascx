<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TablePendingOrders.ascx.cs" Inherits="HTML_Ecommerce_Store1.HTML_Ecommerce_Store.Administration.Modules.TablePendingOrders" %>
